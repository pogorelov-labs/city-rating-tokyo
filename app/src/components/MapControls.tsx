  ...
  return (
    <div className="absolute top-3 right-3 z-[1000] flex items-center gap-2">
      <button
        ...
        className={`text-xs px-3 py-1.5 min-h-[44px] min-w-[44px] rounded-lg border shadow-sm transition-colors ${
          heatmapMode
      ...
      {heatmapMode && (
        <select
          ...
          className="text-xs px-2 py-1.5 min-h-[44px] rounded-lg border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
